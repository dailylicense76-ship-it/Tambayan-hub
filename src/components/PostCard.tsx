...
import { ShoppingBag, Heart, MessageCircle, Share2, MoreHorizontal } from 'lucide-react';
...
export const PostCard: React.FC<PostProps> = ({ user, content, commerce, stats, onOrderClick }) => {
  return (
    <article id={`post-${user.handle}`} className="glass-card mb-6 overflow-hidden">
      {/* Header */}
